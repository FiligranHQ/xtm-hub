...
describe('Filigran product banner text on public pages', () => {
  it.each`
    ...
    ${true}          | ${/Explore OpenCTI or OpenAEV platform with 30 days/i}
    ${false}         | ${/Explore the full potential of OpenCTI Enterprise Edition, start your 30 days free trial./i}
  `(
    ...
    async ({ isFeatureEnabled, expectedText }) => {
      ...
      const { queryByText } = testRender(
        <PublicTryFiligranProductsBanner
          isOpenAEVTrialEnabled={isFeatureEnabled}
        />,
        {
