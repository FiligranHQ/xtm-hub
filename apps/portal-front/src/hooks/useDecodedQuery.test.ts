...
describe('useDecodedQuery', () => {
  it('should decode URL-encoded query parameters', () => {
    const mockSearchParams = new URLSearchParams('name=hello%20world&id=test%2Fvalue');
  ...
  it('should handle special characters in encoded query params', () => {
    const mockSearchParams = new URLSearchParams('q=%E4%B8%AD%E6%96%87&tag=%23test');
    vi.mocked(useSearchParams).mockReturnValue(mockSearchParams);
