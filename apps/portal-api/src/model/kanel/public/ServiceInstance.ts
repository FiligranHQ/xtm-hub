...
import type { ServiceInstanceCreationStatus, ServiceInstanceJoinType, ServiceInstanceTag } from '../../../__generated__/resolvers-types';
...
export default interface ServiceInstance {
  ...
  join_type: ServiceInstanceJoinType | null;
