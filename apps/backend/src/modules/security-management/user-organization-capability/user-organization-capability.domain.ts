...
export const UserOrganizationCapabilityDomain = {
  createUserOrganizationCapability: async ({
  ...
  updateUserOrganizationCapability: async ({
    user_organization_id,
    capabilities_name,
  }: {
    user_organization_id: UserOrganizationId;
  ...
  loadUserOrganizationCapabilities: async (
