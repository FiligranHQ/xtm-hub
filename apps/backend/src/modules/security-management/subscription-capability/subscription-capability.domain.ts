...
export const SubscriptionCapabilityDomain = {
  ...
  addCapabilitiesToSubscription: async (
    subscriptionId: SubscriptionId,
    capabilityIds: ServiceCapabilityId[]
  ): Promise<SubscriptionCapability[]> => {
    return SubscriptionCapabilityDomain.addCapabilitiesToSubscriptions(
      [subscriptionId],
      capabilityIds
    );
  },

  addCapabilitiesToSubscriptions: async (
  ...
  replaceCapabilitiesForSubscription: async (
    subscriptionId: SubscriptionId,
    capabilityIds: ServiceCapabilityId[]
  ): Promise<SubscriptionCapability[]> => {
  ...
  loadSubscriptionCapabilities: async (subscriptionId: SubscriptionId) => {
    return db<SubscriptionCapability>('Subscription_Capability')
