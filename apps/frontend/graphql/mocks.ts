...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        undeployedResourceTypesByProduct: overrides && overrides.hasOwnProperty('undeployedResourceTypesByProduct') ? overrides.undeployedResourceTypesByProduct! : [relationshipsToOmit.has('UndeployedResourceTypesByProduct') ? {} as UndeployedResourceTypesByProduct : mockUndeployedResourceTypesByProduct({}, relationshipsToOmit)],
...
export const mockUndeployedResourceTypesByProduct = (overrides?: Partial<UndeployedResourceTypesByProduct>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'UndeployedResourceTypesByProduct' } & UndeployedResourceTypesByProduct => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('UndeployedResourceTypesByProduct');
    return {
        ...
        resourceTypes: overrides && overrides.hasOwnProperty('resourceTypes') ? overrides.resourceTypes! : [DeployableResourceType.CustomDashboards],
    };
};
