...
export const mockIngestManifestSuccess = (overrides?: Partial<IngestManifestSuccess>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'IngestManifestSuccess' } & IngestManifestSuccess => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('IngestManifestSuccess');
    return {
        __typename: 'IngestManifestSuccess',
        invalidUseCasesByConnector: overrides && overrides.hasOwnProperty('invalidUseCasesByConnector') ? overrides.invalidUseCasesByConnector! : [relationshipsToOmit.has('InvalidUseCasesByConnector') ? {} as InvalidUseCasesByConnector : mockInvalidUseCasesByConnector({}, relationshipsToOmit)],
        success: overrides && overrides.hasOwnProperty('success') ? overrides.success! : false,
        warnings: overrides && overrides.hasOwnProperty('warnings') ? overrides.warnings! : ['colo'],
    };
};
...
export const mockInvalidUseCasesByConnector = (overrides?: Partial<InvalidUseCasesByConnector>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'InvalidUseCasesByConnector' } & InvalidUseCasesByConnector => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('InvalidUseCasesByConnector');
    return {
        __typename: 'InvalidUseCasesByConnector',
        contractSlug: overrides && overrides.hasOwnProperty('contractSlug') ? overrides.contractSlug! : 'vestrum',
        contractTitle: overrides && overrides.hasOwnProperty('contractTitle') ? overrides.contractTitle! : 'acer',
        invalidUseCases: overrides && overrides.hasOwnProperty('invalidUseCases') ? overrides.invalidUseCases! : ['tubineus'],
    };
};
...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        ingestManifestFragments: overrides && overrides.hasOwnProperty('ingestManifestFragments') ? overrides.ingestManifestFragments! : relationshipsToOmit.has('IngestManifestSuccess') ? {} as IngestManifestSuccess : mockIngestManifestSuccess({}, relationshipsToOmit),
...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        ...
        updateOpenCTIManifest: overrides && overrides.hasOwnProperty('updateOpenCTIManifest') ? overrides.updateOpenCTIManifest! : relationshipsToOmit.has('IngestManifestSuccess') ? {} as IngestManifestSuccess : mockIngestManifestSuccess({}, relationshipsToOmit),
