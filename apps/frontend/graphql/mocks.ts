...
export const mockDeploymentRequest = (overrides?: Partial<DeploymentRequest>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'DeploymentRequest' } & DeploymentRequest => {
    ...
    return {
        ...
        job_title: overrides && overrides.hasOwnProperty('job_title') ? overrides.job_title! : DeploymentRequestJobTitle.ApplicationSecuritySpecialist,
        last_connectivity_check: overrides && overrides.hasOwnProperty('last_connectivity_check') ? overrides.last_connectivity_check! : '2021-03-23T03:14:00.196Z',
        license: overrides && overrides.hasOwnProperty('license') ? overrides.license! : PlatformContract.Ce,
        name: overrides && overrides.hasOwnProperty('name') ? overrides.name! : 'cursim',
