...
export const mockQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Query' } & Query => {
    ...
    return {
        __typename: 'Query',
        activeXtmPlatformBundle: overrides && overrides.hasOwnProperty('activeXtmPlatformBundle') ? overrides.activeXtmPlatformBundle! : relationshipsToOmit.has('XtmPlatformBundle') ? {} as XtmPlatformBundle : mockXtmPlatformBundle({}, relationshipsToOmit),
...
export const mockXtmPlatformBundle = (overrides?: Partial<XtmPlatformBundle>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'XtmPlatformBundle' } & XtmPlatformBundle => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('XtmPlatformBundle');
    return {
        __typename: 'XtmPlatformBundle',
        end_date: overrides && overrides.hasOwnProperty('end_date') ? overrides.end_date! : '2021-12-04T16:56:04.593Z',
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id! : 'ae5410eb-9a00-4273-9c8e-97111a787ef0',
        license: overrides && overrides.hasOwnProperty('license') ? overrides.license! : PlatformContract.Ce,
        organization_name: overrides && overrides.hasOwnProperty('organization_name') ? overrides.organization_name! : 'civis',
        products: overrides && overrides.hasOwnProperty('products') ? overrides.products! : [relationshipsToOmit.has('XtmPlatformBundleProduct') ? {} as XtmPlatformBundleProduct : mockXtmPlatformBundleProduct({}, relationshipsToOmit)],
        requester_email: overrides && overrides.hasOwnProperty('requester_email') ? overrides.requester_email! : 'consectetur',
        service_instance_id: overrides && overrides.hasOwnProperty('service_instance_id') ? overrides.service_instance_id! : 'consequuntur',
        start_date: overrides && overrides.hasOwnProperty('start_date') ? overrides.start_date! : '2021-03-22T11:48:17.765Z',
    };
};

export const mockXtmPlatformBundleProduct = (overrides?: Partial<XtmPlatformBundleProduct>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'XtmPlatformBundleProduct' } & XtmPlatformBundleProduct => {
    const relationshipsToOmit: Set<string> = new Set(_relationshipsToOmit);
    relationshipsToOmit.add('XtmPlatformBundleProduct');
    return {
        __typename: 'XtmPlatformBundleProduct',
        connectivity_status: overrides && overrides.hasOwnProperty('connectivity_status') ? overrides.connectivity_status! : PlatformConfigurationStatus.Active,
        last_connectivity_check: overrides && overrides.hasOwnProperty('last_connectivity_check') ? overrides.last_connectivity_check! : '2021-09-10T23:26:00.358Z',
        name: overrides && overrides.hasOwnProperty('name') ? overrides.name! : 'qui',
        platform_identifier: overrides && overrides.hasOwnProperty('platform_identifier') ? overrides.platform_identifier! : PlatformIdentifier.Openaev,
        roles: overrides && overrides.hasOwnProperty('roles') ? overrides.roles! : [relationshipsToOmit.has('ServiceGroup') ? {} as ServiceGroup : mockServiceGroup({}, relationshipsToOmit)],
        service_instance_id: overrides && overrides.hasOwnProperty('service_instance_id') ? overrides.service_instance_id! : 'nulla',
        url: overrides && overrides.hasOwnProperty('url') ? overrides.url! : 'arto',
    };
};
