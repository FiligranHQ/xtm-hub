...
export const mockSuccess = (overrides?: Partial<Success>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Success' } & Success => {
    ...
    return {
        ...
        warnings: overrides && overrides.hasOwnProperty('warnings') ? overrides.warnings! : ['ulterius'],
    };
};
