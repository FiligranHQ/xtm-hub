// Original source: https://github.com/vendure-ecommerce/vendure/blob/master/packages/common/src/omit.ts
...
export function omit<T extends object | any[], _K extends keyof T>(
  obj: T,
  keysToOmit: string[],
  recursive: boolean
): T;
