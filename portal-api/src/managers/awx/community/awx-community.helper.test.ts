...
import { AWXCommunity, mapCreateCommunityAWX } from './awx-community.helper';
...
describe('Api create-community', async () => {
  it('Should return correct mapping', async () => {
    ...
    const result = await mapCreateCommunityAWX(
      {
        id: '575d37c8-53ed-4c63-ae86-2d8d10f14eaf' as ServiceId,
        adminCommuId: 'ba091095-418f-4b4f-b150-6c9295e232c3' as UserId,
      },
