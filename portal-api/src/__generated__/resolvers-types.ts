...
export type ResolversInterfaceTypes<RefType extends Record<string, unknown>> = ResolversObject<{
  Node: ( ActionTracking ) | ( Capability ) | ( MalwareAnalysis ) | ( MalwareAnalysisResult ) | ( MergeEvent ) | ( MessageTracking ) | ( Organization ) | ( RolePortal ) | ( RolePortalId ) | ( Service ) | ( ServiceCapability ) | ( Subscription ) | ( User ) | ( UserService );
}>;
...
export type NodeResolvers<ContextType = PortalContext, ParentType extends ResolversParentTypes['Node'] = ResolversParentTypes['Node']> = ResolversObject<{
  __resolveType: TypeResolveFn<'ActionTracking' | 'Capability' | 'MalwareAnalysis' | 'MalwareAnalysisResult' | 'MergeEvent' | 'MessageTracking' | 'Organization' | 'RolePortal' | 'RolePortalID' | 'Service' | 'ServiceCapability' | 'Subscription' | 'User' | 'UserService', ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
}>;
...
export type QueryResolvers<ContextType = PortalContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  serviceUsers?: Resolver<Maybe<Array<Maybe<ResolversTypes['UserService']>>>, ParentType, ContextType, RequireFields<QueryServiceUsersArgs, 'id'>>;
