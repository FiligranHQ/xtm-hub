...
export type AddServicePriceInput = {
  fee_type?: InputMaybe<Scalars['String']['input']>;
  price?: InputMaybe<Scalars['Int']['input']>;
  service_definition_id?: InputMaybe<Scalars['ID']['input']>;
};
...
export type Service_CapaDirectiveResolver<
  Result,
  Parent,
  ContextType = PortalContext,
  Args = Service_CapaDirectiveArgs,
> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
...
export type DocumentConnectionResolvers<
  ContextType = PortalContext,
  ParentType extends
    ResolversParentTypes['DocumentConnection'] = ResolversParentTypes['DocumentConnection'],
> = ResolversObject<{
  edges?: Resolver<
    Array<ResolversTypes['DocumentEdge']>,
    ParentType,
    ContextType
  >;
...
export type DocumentEdgeResolvers<
  ContextType = PortalContext,
  ParentType extends
    ResolversParentTypes['DocumentEdge'] = ResolversParentTypes['DocumentEdge'],
> = ResolversObject<{
...
export type MeUserSubscriptionResolvers<
  ContextType = PortalContext,
  ParentType extends
    ResolversParentTypes['MeUserSubscription'] = ResolversParentTypes['MeUserSubscription'],
> = ResolversObject<{
...
> = ResolversObject<{
  addDocument?: Resolver<
    ResolversTypes['Document'],
    ParentType,
    ContextType,
    Partial<MutationAddDocumentArgs>
  >;
  addOrganization?: Resolver<
    Maybe<ResolversTypes['Organization']>,
    ParentType,
    ContextType,
    RequireFields<MutationAddOrganizationArgs, 'input'>
  >;
  addServiceInstance?: Resolver<
    Maybe<ResolversTypes['Subscription']>,
    ParentType,
    ContextType,
    Partial<MutationAddServiceInstanceArgs>
  >;
  ...
  addSubscription?: Resolver<
    Maybe<ResolversTypes['ServiceInstance']>,
    ParentType,
    ContextType,
    Partial<MutationAddSubscriptionArgs>
  >;
  addSubscriptionInService?: Resolver<
    Maybe<ResolversTypes['ServiceInstance']>,
    ParentType,
    ContextType,
    Partial<MutationAddSubscriptionInServiceArgs>
  >;
  addUser?: Resolver<
  ...
  >;
  changeSelectedOrganization?: Resolver<
    Maybe<ResolversTypes['User']>,
    ParentType,
    ContextType,
    RequireFields<MutationChangeSelectedOrganizationArgs, 'organization_id'>
  >;
  ...
  >;
  deleteServiceInstance?: Resolver<
    Maybe<ResolversTypes['ServiceInstance']>,
    ParentType,
    ContextType,
    RequireFields<MutationDeleteServiceInstanceArgs, 'id'>
  >;
  ...
  >;
  editServiceInstance?: Resolver<
    Maybe<ResolversTypes['ServiceInstance']>,
    ParentType,
    ContextType,
    RequireFields<MutationEditServiceInstanceArgs, 'id' | 'name'>
  >;
  editUser?: Resolver<
    ResolversTypes['User'],
    ParentType,
  ...
  >;
  frontendErrorLog?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    RequireFields<MutationFrontendErrorLogArgs, 'message'>
  >;
  login?: Resolver<
    Maybe<ResolversTypes['User']>,
    ParentType,
...
> = ResolversObject<{
  documentExists?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType,
    Partial<QueryDocumentExistsArgs>
  >;
  documents?: Resolver<
    ResolversTypes['DocumentConnection'],
    ParentType,
    ContextType,
    RequireFields<QueryDocumentsArgs, 'first' | 'orderBy' | 'orderMode'>
  >;
  ...
  >;
  publicServiceInstances?: Resolver<
  ...
  rolesPortal?: Resolver<
    ...
    ContextType
  >;
  serviceInstanceById?: Resolver<
    Maybe<ResolversTypes['ServiceInstance']>,
    ParentType,
    ContextType,
    Partial<QueryServiceInstanceByIdArgs>
  >;
  serviceInstanceByIdWithSubscriptions?: Resolver<
    Maybe<ResolversTypes['ServiceInstance']>,
    ParentType,
    ContextType,
    Partial<QueryServiceInstanceByIdWithSubscriptionsArgs>
  >;
  serviceInstances?: Resolver<
    ResolversTypes['ServiceConnection'],
    ParentType,
    ContextType,
    RequireFields<QueryServiceInstancesArgs, 'first' | 'orderBy' | 'orderMode'>
  >;
  ...
  >;
  userHasOrganizationWithSubscription?: Resolver<
    ResolversTypes['Boolean'],
    ParentType,
    ContextType
  >;
...
> = ResolversObject<{
  edges?: Resolver<
    Array<ResolversTypes['ServiceInstanceEdge']>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
...
export type ServiceDefinitionResolvers<
  ContextType = PortalContext,
  ParentType extends
    ResolversParentTypes['ServiceDefinition'] = ResolversParentTypes['ServiceDefinition'],
> = ResolversObject<{
  description?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
...
export type ServiceInstanceResolvers<
  ContextType = PortalContext,
  ParentType extends
    ResolversParentTypes['ServiceInstance'] = ResolversParentTypes['ServiceInstance'],
> = ResolversObject<{
  ...
  >;
  public?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  service_definition?: Resolver<
    Maybe<ResolversTypes['ServiceDefinition']>,
    ParentType,
    ContextType
  >;
  subscribed?: Resolver<
...
export type ServiceInstanceEdgeResolvers<
  ContextType = PortalContext,
  ParentType extends
    ResolversParentTypes['ServiceInstanceEdge'] = ResolversParentTypes['ServiceInstanceEdge'],
> = ResolversObject<{
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type ServiceInstanceSubscriptionResolvers<
  ContextType = PortalContext,
  ParentType extends
    ResolversParentTypes['ServiceInstanceSubscription'] = ResolversParentTypes['ServiceInstanceSubscription'],
> = ResolversObject<{
  add?: Resolver<
    Maybe<ResolversTypes['ServiceInstance']>,
    ParentType,
...
> = ResolversObject<{
  ActionTracking?: SubscriptionResolver<
    ...
    ContextType
  >;
  MeUser?: SubscriptionResolver<
    Maybe<ResolversTypes['MeUserSubscription']>,
    'MeUser',
    ParentType,
    ContextType
  >;
  ServiceInstance?: SubscriptionResolver<
    Maybe<ResolversTypes['ServiceInstanceSubscription']>,
    'ServiceInstance',
    ParentType,
    ContextType
  >;
  ...
  organization_id?: SubscriptionResolver<
    ...
    ContextType
  >;
  service_instance?: SubscriptionResolver<
    Maybe<ResolversTypes['ServiceInstance']>,
    'service_instance',
    ParentType,
    ContextType
  >;
  service_instance_id?: SubscriptionResolver<
    ResolversTypes['ID'],
    'service_instance_id',
    ParentType,
    ContextType
  ...
  user_service?: SubscriptionResolver<
    Array<Maybe<ResolversTypes['UserService']>>,
    'user_service',
    ParentType,
    ContextType
  >;
...
> = ResolversObject<{
  capabilities?: Resolver<
    Maybe<Array<ResolversTypes['Capability']>>,
    ParentType,
    ContextType
  >;
  ...
  organizations?: Resolver<
    ...
    ContextType
  >;
  roles_portal?: Resolver<
    Maybe<Array<ResolversTypes['RolePortal']>>,
    ParentType,
    ContextType
  >;
  selected_organization_id?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType
  >;
