...
export type ResolversInterfaceTypes<RefType extends Record<string, unknown>> = ResolversObject<{
  Node: ( ActionTracking ) | ( Capability ) | ( MergeEvent ) | ( MessageTracking ) | ( Organization ) | ( RolePortal ) | ( RolePortalId ) | ( Service ) | ( Subscription ) | ( User );
}>;
...
export type MalwareAnalysisConnectorResolvers<ContextType = PortalContext, ParentType extends ResolversParentTypes['MalwareAnalysisConnector'] = ResolversParentTypes['MalwareAnalysisConnector']> = ResolversObject<{
  connectors?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type MutationResolvers<ContextType = PortalContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  malwareAnalysis?: Resolver<ResolversTypes['MalwareAnalysisConnector'], ParentType, ContextType, Partial<MutationMalwareAnalysisArgs>>;
  malwareAnalysisResult?: Resolver<Maybe<ResolversTypes['MalwareAnalysisResult']>, ParentType, ContextType, RequireFields<MutationMalwareAnalysisResultArgs, 'id' | 'result' | 'status'>>;
...
export type NodeResolvers<ContextType = PortalContext, ParentType extends ResolversParentTypes['Node'] = ResolversParentTypes['Node']> = ResolversObject<{
  __resolveType: TypeResolveFn<'ActionTracking' | 'Capability' | 'MergeEvent' | 'MessageTracking' | 'Organization' | 'RolePortal' | 'RolePortalID' | 'Service' | 'Subscription' | 'User', ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
}>;
...
export type ServiceResolvers<ContextType = PortalContext, ParentType extends ResolversParentTypes['Service'] = ResolversParentTypes['Service']> = ResolversObject<{
  ...
  subscription_type?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
