...
const Menu = () => {
  ...
  return (
    <aside
      className={cn(
        'mobile:hidden z-20 sticky flex-shrink-0 top-0 left-0 flex h-full flex-col overflow-y-auto overflow-x-hidden bg-page-background duration-300 ease-in-out',
        open ? 'w-48' : 'w-14'
      )}>
      <MenuLogo />
