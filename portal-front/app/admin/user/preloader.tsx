...
export const PreloaderQuery = graphql`
    query preloaderUserQuery($count: Int!, $cursor: ID, $orderBy: UserOrdering!, $orderMode: OrderingMode!) {
        ...userList_users
    }
`;
...
interface PreloaderProps {
    preloadedQuery: SerializablePreloadedQuery<typeof preloaderUserQueryNode, preloaderUserQuery>
}
